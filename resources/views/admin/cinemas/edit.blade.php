                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <div class="flex-shrink-0">
                                    <img id="preview"
                                        src="{{ $cinema->image ? Storage::url($cinema->image) : 'https://via.placeholder.com/100x100' }}"
                                        alt="Preview" class="h-20 w-20 object-cover rounded border border-gray-300">
                                </div>
                            </div>
                    ...
                    <div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="phone" id="phone" value="{{ old('phone', $cinema->phone) }}"
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="facilities" id="facilities"
                                value="{{ old('facilities', is_array($cinema->facilities) ? implode(', ', $cinema->facilities) : $cinema->facilities) }}"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">
                        </div>
                    </div>
                </div>
