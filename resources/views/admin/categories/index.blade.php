...
@section('content')
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        ...
                                        {{ $category->films_count ?? $category->films->count() }} films
                                    </span>
                                </td>
    ...
    <div id="deleteModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden items-center justify-center z-50">
        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-sm mx-auto">
            ...
            <p class="text-gray-600 dark:text-gray-400 mb-6">Are you sure you want to delete this category? Films in this
                category will be uncategorized.</p>
