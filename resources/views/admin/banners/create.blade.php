                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex-shrink-0">
                            <img id="preview" src="https://via.placeholder.com/120x60" alt="Preview"
                                class="h-15 w-30 object-cover rounded border border-gray-300">
                        </div>
                    </div>
                        ...
                        <div class="flex items-center space-x-4">
                            <label class="inline-flex items-center">
                                <input type="radio" name="is_active" value="1"
                                    {{ old('is_active', '1') == '1' ? 'checked' : '' }} class="form-radio text-blue-600">
                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Active</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" name="is_active" value="0"
                                    {{ old('is_active') == '0' ? 'checked' : '' }} class="form-radio text-blue-600">
