...
@section('content')
    <!-- Hero Section -->
    <section class="relative bg-cover bg-center text-white min-h-screen flex items-center"
                ...
                <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-400">+62 888 0920 3620 </p>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">+62 882 2046 6442</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-400">bpixid@gmail.com</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
                        ...
                        <div class="flex space-x-4">
                            <a href="https://www.facebook.com/share/1B2za7pkbN/"
                            ...
                            <a href="https://www.instagram.com/bpixid?igsh=MTJzdnh6Y2thbzc1Ng=="
    ...
    @push('scripts')
        <script>
            document.getElementById('contactForm').addEventListener('submit', function(e) {
                ...
                Alpine.$data(this).submitted = true;

                // Here you would normally send AJAX request
                setTimeout(() => {
                    alert('Thank you for your message! We will get back to you soon.');
                    this.reset();
                    Alpine.$data(this).submitted = false;
                }, 1500);
            });
        </script>
    @endpush
