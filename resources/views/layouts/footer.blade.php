@php
    $settings = [
        ...
        'facebook_url' => \App\Models\Setting::get('facebook_url', 'piwcoders'),
        'instagram_url' => \App\Models\Setting::get('instagram_url', '@piwcoders'),
        'twitter_url' => \App\Models\Setting::get('twitter_url', '#'),
        'youtube_url' => \App\Models\Setting::get('youtube_url', '#'),
        'contact_email' => \App\Models\Setting::get('contact_email', 'info@tix.com'),
        'contact_phone' => \App\Models\Setting::get('contact_phone', '+62 21 1234 5678'),
        'address' => \App\Models\Setting::get('address', 'Jakarta, Indonesia'),
    ];
@endphp
                ...
                <div class="flex space-x-4">
                    ...
                    @if ($settings['twitter_url'] && $settings['twitter_url'] != '#')
                        <a href="{{ $settings['twitter_url'] }}" target="_blank" rel="noopener noreferrer"
                            class="text-gray-400 hover:text-blue-400 dark:hover:text-blue-400 transition transform hover:scale-110">
                    ...
                    @if ($settings['youtube_url'] && $settings['youtube_url'] != '#')
                        <a href="{{ $settings['youtube_url'] }}" target="_blank" rel="noopener noreferrer"
                            class="text-gray-400 hover:text-red-600 dark:hover:text-red-400 transition transform hover:scale-110">
